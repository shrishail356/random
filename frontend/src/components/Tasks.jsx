              ...
              tasks.map((task, index) => (
                <div key={task._id} className="bg-white my-4 p-4 text-gray-600 rounded-md shadow-md">
                  <div className="flex">
                    ...
                    {/* Display Priority */}
                    <span className="ml-4 font-medium text-blue-500">Priority: {task.priority}</span>

                    {/* Display Due Date */}
                    <span className="ml-4 font-medium text-orange-500">Due Date: {task.dueDate}</span>
                    ...
                    <Tooltip text={'Mark Completed'} position={'top'}>
